...
CONST.GRAPHICS_MAP = {
	["greencircuit-asif"] = {icon = "greencircuit-asif.png", tint = {r= .2, g = .6, b = .01, a = 1}},
	["redcircuit-asif"] = {icon = "redcircuit-asif.png", tint = {r= .78, g = .01, b = .01, a = 1}},
	["bluecircuit-asif"] = {icon = "bluecircuit-asif.png", tint = {r= .2, g = .13, b = .72, a = 1}},
	["lowdensitystructure-asif"] = {icon = "lowdensitystructure-asif.png", tint = {r= .88, g = .75, b = 0.5, a = 1}},
	["heatshielding-asif"] = {icon = "se-hs-asif.png", tint = {r= 64, g = 69, b = 74, a = 255}},
	["engine-asif"] = {icon = "eng-asif.png", tint = {r= .49, g = .35, b = .31, a = 1}},
	["plastic-asif"] = {icon = "plastic-asif.png", tint = data.raw.recipe["plastic-bar"].crafting_machine_tint.primary},
	["rocketfuel-asif"] = {icon = "rocketfuel-asif.png", tint = {r= .8, g = .65, b = .11, a = 1}},
	["solidfuel-petroleumgas-asif"] = {icon = "solidfuel-petroleumgas-asif.png", tint = data.raw.recipe["solid-fuel-from-petroleum-gas"].crafting_machine_tint.primary},
	["solidfuel-lightoil-asif"] = {icon = "solidfuel-lightoil-asif.png", tint = data.raw.recipe["solid-fuel-from-light-oil"].crafting_machine_tint.primary},
	["solidfuel-heavyoil-asif"] = {icon = "solidfuel-heavyoil-asif.png", tint = data.raw.recipe["solid-fuel-from-heavy-oil"].crafting_machine_tint.primary},
	["rocketcontrolunit-asif"] = {icon = "rocketcontrolunit-asif.png", tint = {181, 255, 181, 255}},
	["prod-3-asif"] = {icon = "module-productivity3-asif.png", tint = {r= 240, g = 66, b = 19, a = 255}},
	["spd-3-asif"] = {icon = "module-speed3-asif.png", tint = {r= .25, g = .93, b = .92, a = 1}},
	["eff-3-asif"] = {icon = "module-effectivity3-asif.png", tint = {r= 0, g = 1, b = 0, a = 1}},
	...
	["arty-shell-asif"] = {icon = "artillery-shell-asif.png", tint = {r= 255, g = 149, b = 0, a = 255}},
	["beacon-asif"] = {icon = "beacon-asif-v2.png", tint = {r= 156, g = 99, b = 66, a = 255}},
}
